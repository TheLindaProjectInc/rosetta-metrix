...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/TheLindaProjectInc/rosetta-metrix/metrixsuite/btcd/wire)
=======
...
```bash
$ go get -u github.com/TheLindaProjectInc/rosetta-metrix/metrixsuite/btcd/wire
```
