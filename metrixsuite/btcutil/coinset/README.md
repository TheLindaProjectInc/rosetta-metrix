...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/TheLindaProjectInc/rosetta-metrix/metrixsuite/btcutil/coinset)
...
```bash
$ go get -u github.com/TheLindaProjectInc/rosetta-metrix/metrixsuite/btcutil/coinset
```
